...
/**
 * Test DTO: Validate Rules used when no other rules exist
 */
#[Validate(
    Validator::class,
    new Rules(
        priority: new Rule('min:20'),  // Only rule - requires min 20 chars
    ),
)]
class ValidateRulesPriorityDt0 extends Dt0
{
